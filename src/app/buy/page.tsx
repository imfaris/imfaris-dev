    ...
    <div className="font-sans h-screen flex flex-col items-center justify-center bg-[#16181d] p-0 overflow-hidden">
      <main className="flex flex-col items-center gap-12 w-full max-w-2xl group">
        ...
        <div className="flex flex-row gap-6 w-full max-w-md justify-center">
          <button className="flex-1 py-5 rounded-lg bg-[#23272f] text-emerald-300 text-lg font-semibold shadow hover:bg-[#23272f]/80 hover:text-emerald-200 transition-colors duration-150 border border-[#23272f] focus:outline-none focus:ring-2 focus:ring-emerald-400">SIM</button>
